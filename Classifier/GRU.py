...
for train, test in skf.split(X,y): 
    ...
    print('GRU:acc=%f,precision=%f,npv=%f,sensitivity=%f,specificity=%f,mcc=%f,f1=%f,roc_auc=%f'
...
yscore_sum.to_csv('yscore_sum_GPCR_GRU.csv')

ytest_sum.to_csv('ytest_sum_GPCR_GRU.csv')

data_csv_zhibiao.to_csv('GPCR_GRU.csv')
