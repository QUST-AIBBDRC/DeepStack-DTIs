...
for train, test in skf.split(X,y): 
    ...
    print('Ada:acc=%f,precision=%f,npv=%f,sensitivity=%f,specificity=%f,mcc=%f,f1=%f,roc_auc=%f'
...
yscore_sum.to_csv('yscore_sum_GPCR_Ada.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_GPCR_Ada.csv')
